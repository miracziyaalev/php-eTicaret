 ...
 <?php 
                    ...
                    while ($slidercek=$slider->fetch(PDO::FETCH_ASSOC)) {?>
                                    ...
                                    <div style="background-image: url(Admin/resimler/slider/<?php echo $slidercek['slider_resim'] ?>)
                                    !important; "class="single-slide align-center-left  animation-style-01 bg-3">
